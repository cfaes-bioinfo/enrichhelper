...
test_that("run_ora() runs KEGG enrichment for a model organism (ontology_type = 'KEGG')", {
  testthat::skip_if_not_installed("org.Hs.eg.db")
  ...
  # via org.Hs.eg.db's own (older, but sufficiently overlapping) PATH mapping -- enrichKEGG()
